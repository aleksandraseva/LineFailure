...
def connections_view(request):
    ...
    if request.method == "POST":
        ...
        clean_words = [word.replace(" ", "").lower()
                       for word in selected_lines]
        ...
        for word in clean_words:
            ...
            ).filter(clean_line__icontains=word).distinct()
        ...
        for service in services:
            ...
            for word in clean_words:
                matching_routes |= total_routes.annotate(
                    clean_line=Lower(
            ...
            services_data.append({
                "service": service,
                "remaining_routes_count": remaining_routes_count
            })
    else:
        services_data = []
